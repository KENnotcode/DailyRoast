const premiumTea = [
    ...
    {
        "id": 3,
        "name": "My Chic Tea Set",
        "description": "TWG Tea is delighted to offer their discerning customers this delightful pair of Classic Tea Tins in signature yellow filled with two exquisite teas: Saichô Tea and Genmaicha.",
        "price": 89.00,
